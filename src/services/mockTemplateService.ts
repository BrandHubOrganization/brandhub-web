...
const INITIAL_TEMPLATES: ContentTemplate[] = [
  ...
  },
  {
    ...
    caption: 'Tái định nghĩa trải nghiệm sáng tạo nội dung với sự hỗ trợ từ Trợ lý AI Co-Pilot! Chúng tôi vừa ra mắt tính năng sinh bài đăng và hình ảnh tự động giúp tiết kiệm 50% thời gian.',
  ...
  },
  {
    ...
    caption: 'Một tách cà phê nóng khởi đầu ngày mới làm việc tràn đầy năng lượng. Hãy tạo cho mình một khoảng lặng nghỉ ngơi và tận hưởng những điều nhỏ bé xung quanh.',
  ...
  },
  {
    ...
    caption: 'SIÊU BÃO GIẢM GIÁ 50%! Chỉ áp dụng cho 100 khách hàng nhanh tay nhất đặt đơn trong hôm nay. Nhấn vào liên kết bên dưới để săn deal ngay!',
  ...
  },
  {
    ...
    caption: 'Bí quyết dường da căng bóng như sương vào buổi sáng! 5 bước chuẩn hóa giúp phục hồi hàng rào bảo vệ da sau cả ngày dài tiếp xúc với khói bụi.',
  ...
  },
  {
    ...
    caption: 'Biến góc làm việc thành không gian truyền cảm hứng sáng tạo! Sử dụng các tone màu trung tính kết hợp đèn LED dịu nhẹ tạo sự tập trung tối đa.',
...
class MockTemplateService {
  ...
  async getTemplates(params: TemplateQueryParams): Promise<TemplatePaginatedResponse> {
