...
const MOCK_EVENTS: CalendarPostEvent[] = [
  {
    ...
    extendedProps: {
      ...
      status: "SCHEDULED",
      captionPreview:
        "🚀 Exclusive reveal coming tomorrow! Stay tuned for our biggest launch of the year #brandhub #launch",
    },
  },
  {
    id: "post-2",
    ...
    extendedProps: {
      ...
      status: "SCHEDULED",
      captionPreview:
        "Take a peek behind the scenes at our creative workshop 🎨✨",
    },
  },
  {
    id: "post-3",
  ...
  },
  {
    ...
    extendedProps: {
      ...
      status: "DRAFT",
      captionPreview:
        "5 productivity hacks every content creator needs to know in 2026.",
    },
  },
];
